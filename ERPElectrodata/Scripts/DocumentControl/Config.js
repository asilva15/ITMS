...
phonecatApp.config(['$routeProvider',
    function ($routeProvider) {
      $routeProvider
          ...
          .when('/Home_K22', { templateUrl: function (params) { return '/Home/Init_K22?' + Math.random() } })
          .when('/CreateEX1_K22', { templateUrl: function (params) { return '/Ticket/CreateEX1_K22?' + Math. random() } })
          ...
          //.when('/ReporteTarea/:id', { templateUrl: function (params) { return '/Ticket/ReporteTarea' + params.id + '?var=' + Math.random() } })
          .when('/ReporteTicketTarea/:id', { templateUrl: function (params) { return '/Ticket/ReporteTicketTarea/' + params.id + '?var=' + Math.random() } })
          .when('/ReporteTareas', { templateUrl: '/Ticket/ReporteTareas?var=' + Math.random() })
          .when('/ReporteTicketsDeActivos', { templateUrl: '/Ticket/ReporteTicketsDeActivos?var=' + Math.random() })
         /* .when('/FindTicket', { templateUrl: '/Ticket/ReporteTarea?var=' + Math.random() })*/
          .when('/WorkTicket', { templateUrl: '/Ticket/Work?var=' + Math.random() })
          .when('/FormatoInformesAuto', { templateUrl: '/Ticket/FormatoInformesAuto?var=' + Math.random() })

          .when('/ReporteTicketPorTipo', { templateUrl: '/Ticket/ReporteTicketPorTipo?var=' + Math.random() })
          ...
          .when('/ConsolidadoTickets', { templateUrl: '/Ticket/ConsolidadoTickets?var=' + Math.random() })
          .when('/AutoservicioAD', { templateUrl: '/Ticket/AutoservicioAD?var=' + Math.random() })
          .when('/GestionUsuarioSolicitante', { templateUrl: '/AccountEntity/GestionUsuarioSolicitante?var=' + Math.random() })
      
          //Plantillas Buenaventura
          .when('/ListaPlantillaBuenaventura', { templateUrl: '/PlantillaBuenaventura/Principal'})
          .when('/CrearPlantillaBuenaventura', { templateUrl: '/PlantillaBuenaventura/Nuevo'})
          .when('/EditarPlantillaBuenaventura/:id', { templateUrl: function (params) { return '/PlantillaBuenaventura/Editar/' + params.id } })
          ...
          .when('/ConsolidadoClientes', { templateUrl: '/OrderForm/ConsolidadoClientes?var=' + Math.random() })
        ...
        //Asset
          ...
          .when('/NewAssetH', { templateUrl: '/Asset/CreateHudbay' })
          .when('/FindAsset', { templateUrl: '/Asset/Find' })
          .when('/Delivery', { templateUrl: '/DeliveryReception/Create' })
        ...
        //Document Contrato
          .when('/RegistroContrato', { templateUrl: '/DocumentoContrato/Index' })
          .when('/RegistroContrato/Nuevo', { templateUrl: '/DocumentoContrato/Crear' })
          .when('/RegistroContrato/Detalle/:id', { templateUrl: function (params) { return '/DocumentoContrato/Detalle/' + params.id; } })
          .when('/RegistroContrato/Reporte', { templateUrl: '/DocumentoContrato/ReporteContratos' })
        //Talent
          ...
          .when('/ReporteDocUsuarios', { templateUrl: '/Talent/ReporteDocUsuarios' })
          ...
          .when('/MisVacaciones', { templateUrl: '/Vacaciones/MisVacaciones' })
          .when('/VacacionesMisSolicitudes', { templateUrl: '/Vacaciones/MisSolicitudes' })
          //Account
        ...
        //Financial
          ...
          .when('/Details/:id', { templateUrl: function (params) { return '/DeliverySustain/Details/' + params.id } })
        ...
        //Sales
          ...
          .when('/CrearFormato', { templateUrl: '/Inform/CrearFormato' })
      ...
      //Administration
          ...
          .when('/GrupoResolutorHorarios', { templateUrl: '/HorarioGruposResolutores/GrupoResolutorHorarios' })
      ...
      //Activity
          ...
          .when('/DetailsActivityMinsur', { templateUrl: '/Activity/DetailsActivityMinsur' })
      
          .when('/ReporteActivity', { templateUrl: '/Activity/Reportes' })
          .when('/ConsolidadoActividades', { templateUrl: '/Activity/ConsolidadoActividades' })
      //Reporte Activity
      ...
      //Gestion de Cambios
          ...
          .when('/Notificaciones', { templateUrl: '/ChangeRequest/VerTodosNotificaciones' })
           //(ERP)          
          .when('/ResumenGestionCambioBNV/:id', { templateUrl: function (params) { return '/ChangeRequest/ResumenGestionCambioBNV/' + params.id; } })
          .when('/ResumenGestionCambioMinsur/:id', { templateUrl: function (params) { return '/ChangeRequest/ResumenGestionCambioMinsur/' + params.id; } })
          .when('/NewChangeRequestBNV', { templateUrl: '/ChangeRequest/CreateBNV' })
          .when('/NewChangeRequestMINSUR', { templateUrl: '/ChangeRequest/CreateMINSUR' })
      ...
      /*Gestión Documentaria*/
          ...
          /*.when('/Index/', { templateUrl: '/InformeED/Index' })*/
          //.when('/InformeED/Index', { templateUrl: '/InformeED/Index?var=' + Math.random() })
