    ...
    public partial class ReporteGlobal : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                rv_ReporteGlobal.ServerReport.ReportServerCredentials = rvc;
                rv_ReporteGlobal.ProcessingMode = ProcessingMode.Remote;
                rv_ReporteGlobal.ServerReport.ReportServerUrl = new Uri(reportServer);
                rv_ReporteGlobal.ServerReport.ReportPath = "/Activo/RptGlobal";

                rv_ReporteGlobal.ShowPrintButton = true;
                rv_ReporteGlobal.ShowParameterPrompts = false;
                ...
                rv_ReporteGlobal.ServerReport.SetParameters(param);

                rv_ReporteGlobal.ServerReport.Refresh();
            }
        }
    }
}