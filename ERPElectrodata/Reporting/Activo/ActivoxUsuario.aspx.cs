...
{
    public partial class ActivoxUsuario : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                RVActivoxUsuario.ServerReport.ReportPath = "/Activo/ActivoxUsuario";
                ...
                RVActivoxUsuario.ServerReport.SetParameters(param);
